# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-12-30 23:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(default='+39', max_length=16, null=True, validators=[django.core.validators.RegexValidator(message='Numero di telefono non valido', regex='^\\+?\\d{8,15}$')], verbose_name='Cellulare')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materials_price', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Prezzo materiali')),
                ('machinery_price', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Prezzo macchinari')),
                ('description', models.CharField(blank=True, max_length=1000, null=True, verbose_name='Descrizione')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateField(default=datetime.date.today, verbose_name='Data Inizio')),
                ('end_date', models.DateField(default=datetime.date.today, verbose_name='Data Fine')),
