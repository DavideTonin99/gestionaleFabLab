# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-06-23 09:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cap', models.CharField(max_length=5, validators=[django.core.validators.RegexValidator(message='CAP non valido', regex='^\\d{5}$')], verbose_name='CAP')),
                ('telephone', models.CharField(default='+39', max_length=17, validators=[django.core.validators.RegexValidator(message='Numero di telefono non valido', regex='^\\+?\\d{8,15}$')], verbose_name='Cellulare')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.DecimalField(blank=True, decimal_places=2, max_digits=6, null=True, verbose_name='Costo')),
                ('description', models.CharField(blank=True, max_length=1000, null=True, verbose_name='Descrizione')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestionale_.Customer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.DateField(default=datetime.date.today, verbose_name='Anno')),
